...
def search_faq(query: str) -> Optional[Dict[str, str]]:
    ...
    for entry in entries:
        ...
        common = query_tokens & q_tokens

        # Nuevo score: suma de la longitud de las palabras coincidentes
        # (palabras más largas y específicas como "transferencia" pesan más que "necesito")
